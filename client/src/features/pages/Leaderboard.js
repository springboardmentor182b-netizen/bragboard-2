    ...
    <div className="page-container">
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <input
            ...
            style={{ padding: "8px 10px", borderRadius: 8, border: "1px solid #08090aff" }}
          />
      ...
      <div style={{ marginTop: 16, display: "flex", gap: 20, alignItems: "center" }}>
        <div className="your-position-card">
          <div style={{ fontSize: 13, color: "#0c0b0bff" }}>Your Position</div>
          {yourRank ? (
            <>
              <div style={{ fontSize: 20, fontWeight: 700, marginTop: 6 }}>
                {medals(yourRank.rank) } &nbsp; #{yourRank.rank}
              </div>
              <div style={{ fontSize: 14, color: "#080808ff" }}>{yourRank.entry.name}</div>
              <div style={{ fontSize: 13, color: "#131111ff", marginTop: 6 }}>
                {yourRank.entry.points} points • {yourRank.entry.shoutouts} shoutouts
              </div>
            </>
          ) : (
            <div style={{ color: "#0e0d0dff" }}>You are not ranked yet.</div>
          )}
        </div>
      ...
      <div className="leaderboard-container" style={{ marginTop: 18 }}>
        <table className="leaderboard-table">
          ...
          <tbody>
            ...
            {visible.length === 0 && (
              <tr>
                <td colSpan={6} style={{ textAlign: "center", padding: 18, color: "#0d0e11ff" }}>
                  No results.
                </td>
              </tr>
            )}
